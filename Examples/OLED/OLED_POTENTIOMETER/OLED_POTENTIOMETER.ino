...
void loop() {
  ...
  // move the cursor down by 10 pixels (to a new line) to print the degrees value value
  ...
  // Pause for 10 milliseconds to allow the display to update and servo to adjust position
  delay(10);
}
